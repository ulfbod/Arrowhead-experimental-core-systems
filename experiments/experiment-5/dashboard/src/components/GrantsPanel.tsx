...
// Grants drive policy-sync → AuthzForce, which enforces both AMQP and Kafka paths.
  ...
  return (
    <div style={s.wrap}>
      ...
      <section style={s.section}>
        ...
        <p style={s.hint}>
          Grants propagate to AuthzForce within one policy-sync cycle (~10s).
          Both AMQP (topic-auth-xacml) and Kafka (kafka-authz) enforce the same policy.
        </p>
      </section>
    </div>
  )
