...
const s = {
  ...
  details:       { border: '1px solid #ddd', padding: '8px 12px', marginBottom: '1.5rem' },
  summary:       { cursor: 'pointer', fontWeight: 'bold' as const, fontSize: '0.9rem' },
  instrBody:     { marginTop: 10, fontSize: '0.85rem' },
  instrPara:     { marginBottom: 8 },
  instrH:        { fontSize: '0.9rem', marginTop: 12, marginBottom: 4 },
  instrList:     { marginTop: 4, paddingLeft: 20 },
}
