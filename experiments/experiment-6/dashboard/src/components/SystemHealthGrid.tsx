...
const SYSTEMS: SystemDef[] = [
  ...
  { id: 'rest-authz',        label: 'RestAuthz',        healthPath: '/api/rest-authz',        layer: 'experiment' },
  { id: 'robot-fleet',       label: 'RobotFleet',       healthPath: '/api/robot-fleet',       layer: 'experiment' },
  { id: 'data-provider',     label: 'DataProvider',     healthPath: '/api/data-provider',     layer: 'experiment' },
  ...
  { id: 'rest-consumer',     label: 'RestConsumer',     healthPath: '/api/rest-consumer',     layer: 'experiment' },
]
