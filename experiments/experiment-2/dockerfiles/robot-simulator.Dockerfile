...
COPY experiments/experiment-2/services/robot-simulator/ ./experiments/experiment-2/services/robot-simulator/

WORKDIR /src/experiments/experiment-2/services/robot-simulator
