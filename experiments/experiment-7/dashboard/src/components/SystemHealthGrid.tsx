...
const SYSTEMS: SystemDef[] = [
  ...
  { id: 'ca',              label: 'CertAuth (CA)',   healthPath: '/api/ca/ca',           layer: 'core' },
  // ── Support ────────────────────────────────────────────────────────────────
  {
  ...
  { id: 'cert-rest-authz',   label: 'CertRestAuthz(mTLS)',healthPath: '/api/cert-rest-authz',  layer: 'experiment' },
  ...
  { id: 'cert-consumer',     label: 'CertConsumer(mTLS)',healthPath: '/api/cert-consumer',     layer: 'experiment' },
]
...
export function SystemHealthGrid() {
  ...
  return (
    <section>
      ...
      <p style={s.note}>
        Services labelled (TLS) use X.509 certificates issued by the Arrowhead CA.
        Services labelled (mTLS) enforce mutual TLS — consumer identity comes from the client certificate CN.
      </p>
    </section>
  )
}
